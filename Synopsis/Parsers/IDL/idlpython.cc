...
// $Id: idlpython.cc,v 1.22.2.3 2005/01/06 23:11:14 dgrisby Exp $
// $Log: idlpython.cc,v $
...
PythonVisitor()
{
  idlast_  = PyImport_ImportModule((char*)"Synopsis.Parsers.IDL.idlast");
  idltype_ = PyImport_ImportModule((char*)"Synopsis.Parsers.IDL.idltype");
