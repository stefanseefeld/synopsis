...
public:
  ...
  PyObject *addTypedef(size_t, bool, const string &, PyObject *, bool, vector<PyObject *> &);
  PyObject *Enumerator(size_t, bool, const string &, const string &);
  PyObject *addEnum(size_t, bool, const string &, const vector<PyObject *> &);
  PyObject *addVariable(size_t, bool, PyObject *, bool, const vector<PyObject *> &);
  ...
  void pushScope(PyObject *scope) { scopes.push(scope);}
