...
class FrameSet:
    ...
    def process(self, output, filename, title, index, detail, content):
        ...
        out = open_file(os.path.join(output, filename))
        ...
        frame1 = element('frame', name='index', src=index)
        frame2 = element('frame', name='detail', src=detail)
        frame3 = element('frame', name='content', src=content)
