...
from Synopsis.Formatters import open_file_with_encoding
from Tags import *
...
class Format(Parametrized):
    ...
    def view_header(self, os, title, body, headextra, view):
        ...
        os.write("<head>\n")
        os.write('<meta content="text/html; charset=utf-8" http-equiv="Content-Type"/>\n')
...
class View(Parametrized):
    ...
    def open_file(self):
        ...
        return open_file_with_encoding(path, 'utf-8')
