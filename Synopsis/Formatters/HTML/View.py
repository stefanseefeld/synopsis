# $Id: View.py,v 1.11 2002/07/04 06:43:18 chalky Exp $
#
...
#
# $Log: View.py,v $
# Revision 1.11  2002/07/04 06:43:18  chalky
...
class Page:
	...
	The default passes self.filename() to Util.open()"""
	return Util.open(self.filename())
	...
	if len(config.stylesheet):
	    ss = os.path.join(config.basename, config.stylesheet)
	    self.write(entity('link', '', rel='stylesheet', href=rel(self.filename(), ss)) + '\n')
