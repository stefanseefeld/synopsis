...
{
	return new CL_FunctionSlot_v5<PARAM1,PARAM2,PARAM3,PARAM4,PARAM5>(callback);
}
...
template <class CallbackClass, class PARAM1, class PARAM2, class PARAM3, class PARAM4, class PARAM5>
CL_Slot_v5<PARAM1, PARAM2, PARAM3, PARAM4, PARAM5> *CL_CreateSlot(
	CallbackClass *cb_class,
	void (CallbackClass::*callback)(PARAM1, PARAM2, PARAM3, PARAM4, PARAM5))
{
	return new CL_MethodSlot_v5<CallbackClass, PARAM1, PARAM2, PARAM3, PARAM4, PARAM5>(cb_class, callback);
}

/////////////////////////////////////////////////////////////////////////////
// Method / Member function Slot, with user data

template <class CallbackClass, class UserData, class PARAM1, class PARAM2, class PARAM3, class PARAM4, class PARAM5>
class CL_UserDataMethodSlot_v5 : public CL_Slot_v5<PARAM1, PARAM2, PARAM3, PARAM4, PARAM5>
{
public:
	typedef void (CallbackClass::*Callback)(UserData, PARAM1, PARAM2, PARAM3, PARAM4, PARAM5);
	...
	virtual void call(PARAM1 param1, PARAM2 param2, PARAM3 param3, PARAM4 param4, PARAM5 param5) { (cb_class->*callback)(user_data, param1, param2, param3, param4, param5); }
...
CL_Slot_v5<PARAM1, PARAM2, PARAM3, PARAM4, PARAM5> *CL_CreateSlot(
	CallbackClass *cb_class,
	void (CallbackClass::*callback)(UserData, PARAM1, PARAM2, PARAM3, PARAM4, PARAM5),
	UserData user_data)
{
	return new CL_UserDataMethodSlot_v5<CallbackClass, UserData, PARAM1, PARAM2, PARAM3, PARAM4, PARAM5>(cb_class, callback, user_data);
}
